...
# cfg_file = 'configs/body/2d_kpt_sview_rgb_img/' \
#            'topdown_heatmap/coco/hrformer_small_coco_384x288.py'
# src_file = 'models/hrt_small_coco_384x288.pth'

# cfg_file = 'configs/body/2d_kpt_sview_rgb_img/' \
#            'topdown_heatmap/coco/hrformer_base_coco_256x192.py'
# src_file = 'models/hrt_base_coco_256x192.pth'

cfg_file = 'configs/body/2d_kpt_sview_rgb_img/' \
           'topdown_heatmap/coco/hrformer_base_coco_384x288.py'
src_file = 'models/hrt_base_coco_384x288.pth'
